...
### Timely
    ...
    - my jenkins in docker sandbox, enhance for brown bag. THEN: -> kube, ecs, spring boot, ruby, scala, .net core. nosql (distributed system) sandbox. Pull any needed code.

...
docker ws tb
    -test run
    - update versions
    - add teaser for deployment ws - image
    - compose v3, other versions
    - mention orchestion in more detail; - mention docker enterprise with others, have slide comparing
    Add intro/overview to each section, images?
...
quicktime for rec video
sch strategy meeting
get access to systems
pd spreadshhet; pd cleanup, update, try with reports
[02]docker Dylan stuff
nginx bb/curric+actorhttp review
marc h mention on fb?

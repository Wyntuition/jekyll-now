...
- xpert template; invite for next DDSA, template
    ...
    - Goals
        3 months: Further myself as a Docker thought leader by offering the level 1 workshop more, and add a deployment workshop to the series.
            - Docker Workshop Series: Getting Started with Docker Workshop, internal on project and at meetup
            - Docker Workshop Series: Getting Started with Deployment Workshop, at meetup
        6 months: Supplement containers with microservices blog(s), BD cheat sheet(s), and sample app(s).
            - Microservices BD cheatsheet - when to bring up microservices, how to respond to questions, what questions to ask, related tech, etc.
            - Getting started with microservices, Should I be using microservices blogs
            - Sandbox open-source Labs project - build a few microservices working together on different tech stacks, into a orchestrated deployment environment
        1 year: Focus on AWS, Azure and CI/CD technologies to complement containers, creating a working sandbox showcasing these technologies and approaches.
            - Expand microservices sandbox into AWS or Azure
            - Tutorial documentation around creating and deploying microservices




- [some days off - Feb 23 & 26; Mar 9 & 12
- kube SANDBOX?

- MS cheatsheet; then Docker, .NET Core
- blog
    +brown bag on ETL, perf op - Early March
    - 2018 trends
    - Coming SW apol; sw arch, MS hell
    - state of MS from QCon, etc
    - How to get started with MS



- try akka, graph
- DDSA tasks; invite to all, xpert plan template

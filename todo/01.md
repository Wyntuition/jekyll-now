...
- DDSA MEETING:
    What do you think about this DDSA meeting today as far as agenda, also if this one needs to continue given there's already a separate SA leads one? I overwrote the xpert one with this DDSA one, b/c it was too hard to regularly make the meetings useful (another reason I don't think there should be separate SA leads meetings)

- [R-Books] Oreilly CMS compare, leadership books, AI reg read
- [R-Learn]
    - scala
        - video(s); curric fill in
        - app; React; their app
        - Scala Tutorial: One Video


            
    - Data sci class; then AI


- blog on state of containers in federal

- meeting about TTDC CFP & Marketing

- feb, mar safari, mar metro; other expenses

- [R] sandbox: deploy own microservice; setting up in cloud

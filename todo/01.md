...
### Timely
    ...
    - [r] OneNote
    - my jenkins in docker sandbox, enhance for brown bag. THEN: -> kube, ecs, spring boot, ruby, scala, .net core. nosql, consul/prometh/etc (distributed system, see CURRIC note(s)), react, webassembly sandbox. Pull any needed code.

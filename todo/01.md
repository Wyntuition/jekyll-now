...
### Weekly [W]
    ...
    - clean todo's (here, reminders, oneNote), email, tabs, 
...
### TODAY
    ...
    - monthly bills; audit cash flow, update balances
    - [watch] TQQQ
    
### Timely

    - PD: Managers Path analydis, Radical Candor, PD Plan: AI, sandbox
    - [r] OneNote

...
- App:
    - Neat things about my Neighborhood: Nature, ecosystems, plants, trees, parks, bike routes, history, historic points, commerce, famous folks & founders
...
- [each day] - projects, PD - 10x4 (Review top of task lists)
    ...
    * Scala + app, React, Curric;
    ...
    - Kubernetes; microservices, akka; Sandbox

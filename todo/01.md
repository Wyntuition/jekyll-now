...
### Daily [D]
    ...
    - [PD Plan](pd-plan.md) - AI course, Skillu, sandbox, gaps, work books (AWS), 1-Dev*'s
...
### Projects Now [I-NU]
    ...
    - sandbox: deep app w/techniques (real-time streaming, event sourcing, ms, CQRS, v-based arch, ...); 10x4
...
- peeps name to Dylan; update cal for trips & notify bob
- blog on state of containers in federal; state of sw projects & get my checklists

- scala curric finish
- get kube running on AWS and get a deploy

- jete, bombi, ivy spring Jack, etc?
jw lunch
- project checklist
    +local build norms, process, git flow

- presentations, dockerizing your dev wf, dockerizing apps, getting dockerized apps production ready, deploying dockerized app, orchestrators overview
- experience in federal and commercial
- certified consultancy

- [R-Learn!]
    - !!! DOCKER WORKSHOP increment; promote
    - scala tour and on
        - video(s) (Safari, PS & Pockets); curric fill in, 
            - Recipes, https://www.safaribooksonline.com/learning-paths/learning-path-scala/9781789345735/
            - Examples, https://www.safaribooksonline.com/library/view/learn-by-example/9781788993005/
            - Microservices w/Scala, 
        - SAVE code walkthru save-ui, api; 
        - APP: react, scala/play app & execises w/tour; React walkthru (FB data app?)
    - sandbox: deploy own microservice; setting up in cloud
    - [R-Books] Oreilly CMS compare, leadership & consulting books, AI reg read/DS/Future(niche consulting: ms infra, AI, DS class)

### Timely lt

- pay PS; march metro, feb/mar safari;
- book trip w/Matt, let Bob know 
- cover core scala incl trying, +React [i]

- reorder banana pants
- buy goog? in ameritrade

- fix window; floor: research someone (Klamon?)

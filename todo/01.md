...
- send test strategy
    - LISA's note; add summary of plan, and bug list?
    - update health checks, audit, dashboard; 
...
- health check review; -> review with team next week, then self-healing, cloud/ms pattern brown bag
- PD plans update w/cloud arch tab (ecosystem overview, aws/azure subgroups, microservices infra/deployment/monitoring/netflix list)
    ...
    - +microserivces patterns to brown bag/curric: services gateway, discovery, http://microservices.io/patterns/apigateway.html
- update project checklist; add lots of thing (paper notes, current CLs, issues list). Assessment. Review against our project and ongoing maintain.
...
leadership training post thing

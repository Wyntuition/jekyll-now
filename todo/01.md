...
- [R-Books] Oreilly CMS compare, leadership & consulting books, AI reg read/DS/Future(niche consulting: ms infra, AI)
- [R-Learn!]
    - !!! DOCKER WORKSHOP increment; promote
    - review SAVE code, pipelines
    - scala
...
QUEUE:
- invest rest of cash; military hedge?
- PS appraoch
...
- PS: able to put all content in once place and track, assessments
- jekyll deploy

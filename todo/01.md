...
minimum preparation for programming, cmap topic, docker ws touch base, docker cert group outline - min, and cert level - schedule kickoff and explain situation, docker Dylan stuff, testing draft share small group + spreadsheet.
-bio
greminder: cmap, bio, docker videos

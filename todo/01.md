...
- sch 1 day where all I do is org my notes, to do's/reminders, cal, goals, plans, lists
- get wyntuition 3mail fixed
- AI - solidify the curruc
- MS cheatsheet; then Docker, .NET Core; next initative to get into
    - orig notes?
...
- parents about Belle date; research Greece

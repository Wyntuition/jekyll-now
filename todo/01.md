...
[] DISC
[] [] Scala promises prez: vid
- Friday register (anyone else? Update list of friends & single ones), [] jete, bombi, ivy spring Jack, etc?

[]find daily list (so when braindead you keep pace;)
[] belle ty gift
[] come up with dev workflow, PR, CI/CD practices; then test strategy

START HERE FOR WORK START: go thru paper & these to do's in totality
- sync tabs for learning (via pocket I guess)

...
### Timely
    ...
    - my jenkins in docker sandbox, enhance for brown bag. THEN: -> kube, ecs, spring boot, ruby, scala, .net core. nosql, consul/prometh/etc (distributed system, see note(s)) sandbox. Pull any needed code.
    ...
    - future trend blog from Qcon
        - THEN: other xpert tasks (AI projects, skillustrator)

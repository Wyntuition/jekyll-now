...
6 Outside in relationships
    ...
    - kube slides? Compose, other slides, specific to uscis?

    - clean up xpert notes for meeting today;
    - docker WS prep
        - UPDATE:
            ...
            - PREP
                -zoom, ?
    - appraisal work: read 3rd fb, follow up with anyone, work on writing
        - need Seth c-i?
        - review appraisal timeline
    - apply for pos
    - Chris Moon

...
### Daily [D]
    ...
    - [PD Increment](pd-plan.md) - 1-Dev*'s, DS/AI course, sandbox, gaps, work books (AWS), PD plan list
...
-shaker to work
+find well-oiled machine; list companies who are good & do what etc. 

*R: Regs above (GO THRU FULLY SOMETIME)*

START HERE FOR WORK START: go thru paper & these to do's in totality

[] Hope, Cherie event; Cherylin, Friday register (anyone else? Update list of friends & single ones)
...
[] come up with dev debug/process
- FIND OUT WHAT I DON"T KNOW at save
[] [] [] - final scala push - finish vids, first tour pass
    INCREMENT ON EACH:
    - 1 pass thru SAVE apps, test tweak
    - scala & save basics (Tour, CLASS FOR COMPLETENESS/FULLNESS?)
    - 1 pass thru whole curric, add use cases for concepts, & all majoor related concepts: oauth, rest param bp's/etc, API mocks, logging, tracing, code patterns/heuristics, code components - common/etc
...
- [I] !!! DOCKER presentation, WORKSHOP increment; promote [I]

### Timely lt

MENTOR: Jeff?, Matt P?, SR, 
...
- scala talk
- code camp talk vs other talks vs deployment workshop

...
### Today
    ...
    - Come up with xpert vision, plan, agenda
        - VISION:
            ...
            - Major focuses of Excella. Marry with tech trends.
            - Personal focus - share our goals, initatives, ask for feedback
            - Share approaches planned/doing, ask for feedback
        - GENERAL AGENDA:
            - Lightning talk on trends
            - Go over the SDSA trello, look at our tasks, look at other tasks that xperts might tackle
            - Each share their goals, current and planned initatives, and approaches. Feedback. Collaboration?
    
        - catch up on excella stuff

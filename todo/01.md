...
### Goals
    ...
    - Org lists (active, intellectual, community)
        Community: Church, All Souls, AAMC, volunteer/events
        Intellectual: Ivy, 
        Active: biking, sport?, camping
...
### Projects Now [I-NU]
    ...
    - car
    -speakers
    - places to travel before hitched
...
### Today
    ...
    - invite about Docker Christine
    - sch checkins
    - headphone ext to work

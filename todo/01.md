...
- dynamic drops; perf of doc
- xpert template; invite for next DDSA, template; THEN: xpert strategy
...
- SANDBOX: Kube, MS: Play, Node, .NET Core, Rails, Spring Boot; Mongo, Akka, streams
- blog (into 2018 plan)

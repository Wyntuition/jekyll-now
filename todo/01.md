...
- [each day] - projects, PD - 10x4 (Review top of task lists)
    - Scala, React, Curric; exercises for each section/key concept
...
- place in richmond; lawren 

- Belle>Mom April 8; research Greece

- increment: scala, sandbox, deploy CMS

- lawren; lodging; zipcar for wedding

- deploy workshop agenda (mesh wuth talk)

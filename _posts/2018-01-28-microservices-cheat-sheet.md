...
* Can be more complex to manage - more moving parts
  ...
  *Often microservices complexity is **better complexity** than that of a giant monolithic software application though - this must be analyzed up front*
...
* Hard to know how to break up into small pieces
  ...
  *Must be a **business domain expert**, volatile areas of the software and the infrastructure very well*
